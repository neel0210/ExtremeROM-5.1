...
# Galaxy A24 (One UI 8.0)
SOURCE_FIRMWARE=("SM-A245M/COO/354314906239469")
...
SOURCE_DVFSAPP_CONFIG_DVFS_POLICY_FILENAME="dvfs_policy_mt6789_xx"
SOURCE_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME="siop_a24_mt6789v"
SOURCE_FINGERPRINT_CONFIG_SENSOR="google_touch_side,settings=3,navi=1"
SOURCE_LCD_CONFIG_COLOR_WEAKNESS_SOLUTION="0"
SOURCE_LCD_CONFIG_CONTROL_AUTO_BRIGHTNESS="5"
SOURCE_LCD_CONFIG_HFR_DEFAULT_REFRESH_RATE="90"
